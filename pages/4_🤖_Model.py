...
def main():
    ...
    with col1:
        fullyVaccinated = st.number_input("**fullyVaccinated**", min_value=0.0, help="Number of individuals who have completed the full vaccination regimen for COVID-19")
        ...
        partiallyVaccinated = st.number_input("**partiallyVaccinated**", min_value=0.0, help="Number of individuals who have received at least one dose of a COVID-19 vaccine but have not yet completed the full vaccination regimen.")
    ...
    with col2:  
        totalTests = st.number_input("**totalTests**", min_value=0.0, help="Total number of tests for COVID-19")
        totalVaccinations = st.number_input("**totalVaccinations**", min_value=0.0, help="Total number of COVID-19 vaccination doses administered")
        ...
        r3h = st.number_input("**r3h**", min_value=0.0, help="Rainfall 1-month rolling aggregation long term average in mm")
        month = st.number_input("**month**", min_value=1, max_value=12, help="Month in the year")
        if month in [1,3,5,7,8,10,12]:
            day_of_week = st.number_input("**day_of_week**", min_value=1, max_value=31, help="Day in the month")
        else:
            day_of_week = st.number_input("**day_of_week**", min_value=1, max_value=30, help="Day in the month")
